...
//#define SMOKE_INFLATION_RATE_START_PERCENT    (978) // Fixes block 7,000,000 to 9.5%
#define SMOKE_INFLATION_RATE_START_PERCENT    (97) // reduce to ~ SMOKE_INFLATION_RATE_STOP_PERCENT
#define SMOKE_INFLATION_RATE_STOP_PERCENT     (95) // 0.95%
