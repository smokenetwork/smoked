...
#define STEEMIT_INIT_PUBLIC_KEY_STR             (std::string( smoke::protocol::public_key_type(STEEMIT_INIT_PRIVATE_KEY.get_public_key()) ))
...
#define STEEMIT_INIT_SUPPLY_SBD                 int64_t(1000000000ll) // 1000000000ll = 1m tokens
