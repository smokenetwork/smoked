...
namespace smoke { namespace chain {
   ...
   class comment_object : public object < comment_object_type, comment_object >
   {
      ...
      public:
         ...
         /** tracks the total payout this comment has received over time, measured in SMOKE_SYMBOL */
         asset             total_payout_value = asset(0, SMOKE_SYMBOL);
         asset             curator_payout_value = asset(0, SMOKE_SYMBOL);
         asset             beneficiary_payout_value = asset( 0, SMOKE_SYMBOL );
