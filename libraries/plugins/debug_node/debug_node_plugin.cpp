...
)
{
   ...
   smoke::chain::public_key_type debug_public_key;
   if( debug_key != "" )
   {
   ...
   while( produced < count )
   {
      ...
      smoke::chain::public_key_type scheduled_key = scheduled_witness.signing_key;
      if( debug_key != "" )
      {
...
STEEMIT_DEFINE_PLUGIN( debug_node, smoke::plugin::debug_node::debug_node_plugin )
