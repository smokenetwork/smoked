...
struct private_message_operation : public smoke::protocol::base_operation
{
...
FC_REFLECT( smoke::private_message::private_message_operation, (from)(to)(from_memo_key)(to_memo_key)(sent_time)(checksum)(encrypted_message) )

DECLARE_OPERATION_TYPE( smoke::private_message::private_message_plugin_operation )
FC_REFLECT_TYPENAME( smoke::private_message::private_message_plugin_operation )
